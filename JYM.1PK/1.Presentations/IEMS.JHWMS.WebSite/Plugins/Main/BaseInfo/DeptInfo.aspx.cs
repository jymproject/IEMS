...
public partial class Plugins_Main_BaseInfo_DeptInfo : IEMS.Frame.WebUI.Page
{
    ...
    public class __ :IEMS.Frame.WebUI.___  //必须继承___   //Action不能重复，重复会被覆盖
    {
        public __()
        {
            ...
            历史查询 = new PageAction() { ActionId = 10, ActionName = "btn_history_search" };
    ...
    {
        if (hidden_parent_num.Value.ToString() == "" || hidden_parent_num.Value.ToString() == "0")
        {
    ...
    protected void BtnModifySave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SsbDept dep = new SsbDept();//deptManager.GetByObjId(Convert.ToInt32(modify_obj_id.Text));
