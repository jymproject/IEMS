...
public partial class Plugins_JHWMS_TaskManager_TaskErrorHandle : IEMS.JHWMS.WebUI.Page
{
    #region 权限定义
    ...
    public string ConfirmFirstInProduct(string crnForkNo, string taskNo)
    {
        try
        {
            ...
            var crnForkStatus = crnForkStatusService.GetEntityList(new PemCrnForkStatus { CrnForkNo = crnForkNo, TaskNo = itaskNo }).FirstOrDefault();
