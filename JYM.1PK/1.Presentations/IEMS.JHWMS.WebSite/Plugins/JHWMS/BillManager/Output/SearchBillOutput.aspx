<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchBillOutput.aspx.cs" Inherits="Plugins_JHWMS_BillData_SearchBillOutput" %>
                ...
                <ext:GridPanel ID="gridMain" runat="server" Region="Center">
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" DataIndex="BIN_ERR_DESC"     Text="库存提示" Width="180" />
