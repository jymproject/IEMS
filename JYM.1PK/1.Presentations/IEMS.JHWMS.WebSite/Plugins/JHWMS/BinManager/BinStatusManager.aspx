...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var timeout_setonmouseover = function () {
            ...
            var data = App.txtXCellBinNo.getValue();
            setBinStaus("排【" + data + "】的库位信息更新完成！");

        }
        var setonmouseover = function () {
            var data = App.txtXCellBinNo.getValue();
            setBinStaus("排【" + data + "】的库位信息查询完成！");
        ...
        <ext:Viewport ID="viewport" runat="server" Layout="border">
            <Items>
                <ext:Panel runat="server" Region="North" AutoHeight="true">
                    <TopBar>
                        <ext:Toolbar runat="server">
                            <Items>
                                ...
                                <ext:ComboBox ID ="txtXCellBinNo" runat="server" FieldLabel="库位-排号" ReadOnly="false" Width="320" Text="1"
                    ...
                    <Items>
                        <ext:StatusBar runat="server" ID="txtStatusBar" Text="请选择排库位信息查询！"></ext:StatusBar>
                    </Items>
                </ext:Panel>
                <ext:GridPanel ID="gridMain" runat="server" Region="Center" Floatable="false" ColumnLines="true" RowLines="true">
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" DataIndex="WH_NO" Text="请进排库位信息查询" Flex="1" Sortable="false" />
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>
                    ...
                    <Items>
                        <ext:Container runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                            <Items>
                                ...
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="质检状态" Name="CheckStatus" />
                            </Items>
                        </ext:Container>
                    </Items>
                </ext:FormPanel>
