<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrorBinManager.aspx.cs" Inherits="Plugins_JHWMS_BinManager_ErrorBinManager" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var showAddWindows = function (record) {
            ...
            App.direct.IniPageFieldData( {
                success: function (result) {
                    App.txtOrderNo.setValue(result);
                },
                failure: function (errorMsg) {
                    Ext.Msg.alert("错误", "获取订单编号出错");
                    return;
                }
            });
                        ...
                        <ext:GridPanel ID="gridMain" runat="server" Region="Center">
                            ...
                            <ColumnModel runat="server">
                                <Columns>
                                    ...
                                    <ext:Column runat="server" DataIndex="BIN_NO" Text="库位编号" Width="80" />
