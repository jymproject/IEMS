                ...
                <ext:GridPanel ID="gridMain" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server"      DataIndex="TASK_NO"         Text="任务号"           Width="70" />
                            <ext:Column runat="server"      DataIndex="OBJID"           Text="指令ID"           Width="70" />
                            <ext:Column runat="server"      DataIndex="IO_TYPE"         Text="任务类型"         Width="70" />
                            <ext:Column runat="server"      DataIndex="SLOC_NO"         Text="起始位置"         Width="90" />
                            <ext:Column runat="server"      DataIndex="ELOC_NO"         Text="终点位置"         Width="90" />
