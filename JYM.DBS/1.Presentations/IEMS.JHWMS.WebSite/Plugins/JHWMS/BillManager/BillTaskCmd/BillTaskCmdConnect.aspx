<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillTaskCmdConnect.aspx.cs" Inherits="Plugins_JHWMS_BillTaskCmd_BillTaskCmdConnect" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="Panel4" runat="server" Region="Center" AutoHeight="true" Layout="BorderLayout">
                    <Items>
                        <ext:Panel ID="OrderPanel" runat="server" Flex="1" Region="West" Collapsible="true" MultiSelect="false" FolderSort="true"
                            ...
                            <ColumnModel ID="columnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column runat="server" DataIndex="ELOC_NO"              Text="目的地编号" Width="80" />
                                    <ext:Column runat="server" DataIndex="ELOC_NAME"            Text="目的地" Width="120" />
                                    <ext:Column runat="server" DataIndex="LIMIT_BIN_NO"         Text="锁定库位" Width="80"/>
                                    ...
                                    <ext:Column runat="server" DataIndex="REQUIRE_QTY"          Text="单据请求数量" Width="120"/>
                                    ...
                                    <ext:Column runat="server" DataIndex="BIN_ERR_DESC"         Text="库存异常信息" Width="200" />
                         ...
                         <ext:Panel ID="Panel2" runat="server" Region="Center" AutoHeight="true" Layout="BorderLayout">
                            <Items>
                               <ext:Panel ID="TaskPanel" runat="server" Flex="1" Region="North" Collapsible="true" RootVisible="false" MultiSelect="true" FolderSort="true"
                                  ...
                                  <ext:GridPanel ID="GridPanel1" runat="server" Region="Center">
                                    ...
                                    <ColumnModel runat="server">
                                        <Columns>
                                            ...
                                            <ext:Column runat="server" DataIndex="SLOC_NO"  Text="起始点" Width="100"/>
                                            <ext:Column runat="server" DataIndex="ELOC_NO" Text="目的地" Width="100" />
