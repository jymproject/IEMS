...
namespace IEMS.JHWMS.Entity
{
    ...
    /// <summary>
    /// SSP_PAGE_ACTION [SSP_PAGE_ACTION] - 实体类
    /// </summary>
    [Entity(TableName = "SSP_PAGE_ACTION", Description = "SSP_PAGE_ACTION")]
    public class SspPageAction : BaseEntity
    {
        ...
        /// 
        /// </summary>
        [Field(FieldName = "page_menu_id", Description = "",
               DbType = "int(4)", DefaultValue = "",
        ...
        /// 
        /// </summary>
        [Field(FieldName = "action_name", Description = "",
        ...
        /// 
        /// </summary>
        [Field(FieldName = "action_url", Description = "",
               DbType = "nvarchar(300)", DefaultValue = "",
               IsPrimaryKey = false, IsIdentity = false, Nullable = true)]
